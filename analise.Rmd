...
```
Como podemos observar o parlamentar camilo cola gastou um valor bem simbolico mais precisamente R$ 0.62 reais, já os demais gastaram algo entre R$ 10,00 - R$ 20,00, em linhas gerais a diferença entre o que menos gastou e o que mais gastou é algo entre R$ 1485078.31 um valor muito alto.
...
date %>% 
    ...
    geom_hline(yintercept = 45612.53) +
   geom_point(size = 2) + 
    geom_linerange(size = .3) +
   coord_flip() 
